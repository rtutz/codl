...
interface IQuizQuestion {
  ...
  export default function IndividualQuiz({ question, onUpdate }: IndividualQuizProps) {
    ...
    const handleCorrectAnswerChange = (index: number, e: React.FormEvent<HTMLButtonElement>) => {
        const newChoices = [...question.choices];
        newChoices[index] = { ...newChoices[index], isCorrect: (e.target as HTMLInputElement).checked };
        onUpdate({ ...question, choices: newChoices });
      }
